...
if __name__ == "__main__":  # 🔥 QUAN TRỌNG: Bọc toàn bộ code trong đây!
    ...
    for epoch in range(50):
        ...
        model.eval()
        ap, fpr, fnr, acc, loss_val = validate(model, val_loader, "cuda:0" if torch.cuda.is_available() else "cpu")
        model.log_model(epoch, loss, acc, ap, fpr, fnr, loss_val=loss_val)
        print(
